...
const sections = [
  ...
  { heading: 'Data Security', body: 'We apply industry-standard safeguards — encryption in transit, access controls and regular reviews — to protect your information.' },
